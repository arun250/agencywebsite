  ...
  return (
    ...
    <section className="py-24 bg-slate-50 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-24 bg-white p-12 rounded-[2rem] border border-slate-100 shadow-sm">
          <div>
            ...
            <p className="text-lg text-slate-600 leading-relaxed mb-8">
              ...
              Founded by a full-stack engineer with a Master’s degree from TU Dresden, we specialize in building 
        ...
        <h3 className="text-4xl font-bold text-center mb-16 tracking-tighter">Our Core Expertise</h3>
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { title: "Technical Rigor", desc: "Expertise in Laravel, Vue.js, React Native, and Docker.", icon: Cpu },
