...
export default function CreativeHero() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-6 pt-20 text-center bg-slate-50">
      ...
      <div className="z-10 max-w-6xl flex flex-col items-center md:mt-10 mt-10">
        ...
        <h1 className="text-5xl md:text-8xl font-bold leading-[1] tracking-tighter text-slate-950 mb-4">
          Building Digital Experiences That Drive Growth <br />
          <span className="text-3xl md:text-6xl text-teal-600">Your Vision, Our Code</span>
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-16">
          ...
          <button className="px-10 py-5 bg-teal-600 text-white rounded-2xl text-lg font-bold hover:bg-teal-700 transition flex items-center gap-2 shadow-xl shadow-blue-600/20 cursor-pointer">
            Get Started Free →
          </button>
              
            </Link>
<Link href="/#contact">
          <button className="px-10 py-5 bg-white text-slate-900 rounded-2xl text-lg font-bold hover:bg-slate-100 transition border border-slate-200 flex items-center gap-2 cursor-pointer">
